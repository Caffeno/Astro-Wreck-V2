...
/// </summary>
public abstract class GenericLootDropTable<TLootItem, TLootType> where TLootItem : GenericLootDropItem<TLootType>
{
	// List where we'll assign the items.
	[SerializeField]
	public List<TLootItem> lootDropItems;
	...
	public void ValidateTable()
	{
		...
		if (lootDropItems != null && lootDropItems.Count > 0)
		{
			...
			foreach (TLootItem lootDropItem in lootDropItems)
			{
	...
	/// </summary>
	public TLootItem GetRandomItem()
	{
